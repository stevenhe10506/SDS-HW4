...
conf_stop <- confint(boot_comp, level = .95)
conf_stop
```
...
Question: Is there evidence that "The Biggest Loser" or "The Apprentice: Los Angeles" consistently produces a higher mean Q1_Annoyed response among
viewers?
